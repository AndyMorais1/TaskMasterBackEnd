...
CREATE TABLE `tasklists` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKoovxokh798t4etx97ml1xfxx` (`user_id`),
  CONSTRAINT `FKoovxokh798t4etx97ml1xfxx` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `tasklists` VALUES (1,NULL,NULL,NULL,NULL,'Lista 1',1),(2,NULL,NULL,NULL,NULL,'Lista 2',1),(3,NULL,NULL,NULL,NULL,'Lista 3',2);
